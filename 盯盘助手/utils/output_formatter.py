    ...
    def format_stock_info(self, stock_info, output_format='text'):
        ...
        if output_format == 'json':
            ...
            lines = [
                ...
                f"成交量：{format_large_number(stock_info.get('volume', 0) / 10000 if stock_info.get('volume', 0) else 0)}万股",
    ...
    def format_comprehensive_report(self, analysis_result, output_format='text'):
        ...
        if output_format == 'json':
            ...
            lines = [
                ...
                f"涨跌金额：{format_number(stock_info.get('change_amount', 0)):15} 成交量：{format_large_number(stock_info.get('volume', 0) / 10000 if stock_info.get('volume', 0) else 0)}万股",
