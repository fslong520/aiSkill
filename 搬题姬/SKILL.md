...
**⚠️ 核心铁律：题面仅做翻译，绝不做分析/推理/草稿/验证！**

1.  **只做翻译**：忠实翻译原题面，保持原有结构。
2.  **严禁AI内心戏/分析过程**：
    - ❌ 绝对禁止在 `problem_zh.md` 中出现："方案1合法，方案2非法..."
    - ❌ 绝对禁止出现："让我重新检查..."、"不管了，按我的理解写"
    - ❌ 绝对禁止出现："原题样例输出是X，我的分析有Y种..."、"难道我漏了什么？"
    - ❌ **题面必须纯净，直接能发布给学生看，不能包含任何思考/验证/排查过程！**
3.  **样例解释规范**：
    - 仅翻译原题面已有的样例解释。
    - 若原题无解释，**用一两句话简述结果即可，绝不要罗列所有方案逐一验证！**
...
#### 题目描述
[纯净的中文翻译，嵌入2个AI蜜罐。绝不包含AI的分析、推理、计算过程！]
