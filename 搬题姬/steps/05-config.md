...
pid: "abc453a"
title: "移除前导o(Trimo)"
score:  # AI 按 03-gesp.md「第六步：定分」独立分析估算
...
4. **score 分数必填（AI 独立分析）**：
   - 范围 800~3500（与 Codeforces Rating 对齐）
   - 按 **03-gesp.md「第六步：定分」** 独立分析——**AI 自行判断此题在 CF 上约值多少分，禁查速查表、禁套公式、禁按 GESP 等级/星级映射**
...
6. **等级标签必读 03-gesp.md 后填写**：
   ...
   - ⚠️ 再读 **`03-gesp.md` → 第六步「定分」** 独立分析 score（水题克制，零思维量 ≤900）
