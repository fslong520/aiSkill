...
| **装饰** | 克制规整：左上角标签、右上角便利贴、角落小星⋆——标签/便利贴/卡片一律摆正不倾斜，禁止涂鸦、气泡框、波浪线、回形针等杂乱装饰 |
...
**装饰元素**：克制规整——左上角墨蓝标签、右上角柠檬黄便利贴（手写标语）、角落小星⋆（柠檬黄/黛蓝）。一切元素**摆正不倾斜**；无涂鸦、无气泡框、无波浪线、无回形针。高亮用柠檬黄划痕或雾蓝浅底，重点不喧宾夺主。

**背景质感**：暖奶油色纸（#FFF9E6），轻微纤维纹理，无重肌理。撕纸边缘自然柔和，活页孔细线框。留白开阔，不染杂色。

**氛围**：优雅、文气、宁静专注、沉稳从容。不为热闹，但求齐整。

| 颜色   | 色值    | 用途                             |
| ------ | ------- | -------------------------------- |
| 墨蓝   | #26355D | 主标题、标签、分区标题、题号圈、答案字母 |
| 黛蓝   | #3E5C76 | 副标题、图标、代码卡header、卡片顶条 |
| 雾蓝   | #A9BFD9 | 浅辅助、高亮底、卡片顶条         |
| 青碧   | #00CEC9 | 对勾、箭头、记忆框、重点函数名   |
| 暖金   | #E8A33D | 易错点框、提示语、点缀           |
| 柠檬黄 | #FFC312 | 便利贴、下划线、星星、高亮       |
| 奶油白 | #FFF9E6 | 背景纸张                         |
| 雪白   | #FFFFFF | 内容卡片底色                     |
| 墨黑   | #2D2D2D | 正文深色文字                     |
...
| ---------------- | ---------------------------------------- | ---------------------------- | ---------------------------- | -------------------------- | -------------------------- |
| 墨蓝手账（默认） | 墨蓝主调，暖金点睛，优雅规整，文气从容   | 瘦金体（加粗，瘦劲锋棱）     | 优雅、文气、宁静专注         | 墨蓝+黛蓝+暖金+柠檬黄      | 12岁以上正式教学           |
