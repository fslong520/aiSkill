...
name: 笔记手账
version: 1.7.0
description: 笔记手账风格教育知识卡片Prompt生成器。输入知识点，输出瘦金体优雅简洁的手写体结构化Prompt，支持7套风格主题（含二次元/动漫风格、少女粉风格等）。
allowed-tools:
  - Read
  - Write
  - Edit
...
metadata:
  slug: note-journal
  trigger: 笔记手账、知识卡片、打卡海报、教学插图、CSP-J风格、瘦金体、科幻风格、活力手账、青绿新生、蔚蓝格调、二次元风格、动漫风格、JK制服、洛丽塔、女仆装、魔法少女、萌系、少女粉、粉色系、少女风格
---
...
**字体**：**可爱圆体**——圆润饱满，转角柔和，笔画粗细变化大，有手写温度，适合二次元萌系风格。
**装饰元素**：
...
| 二次元/动漫 | 日系动漫美学，大眼萌系，漫画感，JK/洛丽塔/女仆装 | 可爱圆体（圆润饱满） | 可爱、梦幻、萌系、少女心 | 樱花粉+天空蓝+薰衣草紫 |
| **少女粉** | **纯粉甜美少女风，温柔治愈，干净粉嫩** | **可爱圆体（圆润饱满）** | **甜美、温柔、少女心、治愈** | **樱花粉+玫瑰粉+薰衣草紫** |
