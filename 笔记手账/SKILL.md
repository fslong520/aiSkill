...
name: 笔记手账
version: 1.8.0
description: 笔记手账风格教育知识卡片Prompt生成器。输入知识点，输出瘦金体优雅简洁的手写体结构化Prompt，支持8套风格主题（含二次元/动漫风格、少女粉风格、我的世界像素风等）。
allowed-tools:
  - Read
  - Write
  - Edit
...
**字体**：**瘦金体**——笔画瘦劲，锋芒分明，纤细有力，典雅劲健。字号层级分明，标题大气，正文收敛。
...
| 风格        | 视觉特征                                         | 字体                 | 氛围                     | 主色                   |
| ----------- | ------------------------------------------------ | -------------------- | ------------------------ | ---------------------- |
| 经典        | 复古学院风，温润雅致，墨朱赭绿和谐                 | 瘦金体（瘦劲典雅）   | 安静、书卷气             | 墨黑+朱红+赭黄+青绿     |
...
| 二次元/动漫 | 日系动漫美学，大眼萌系，漫画感 | 可爱圆体（圆润饱满） | 可爱、梦幻、萌系、少女心 | 樱花粉+天空蓝+薰衣草紫 |
| **少女粉** | **纯粉甜美少女风，温柔治愈，干净粉嫩** | **可爱圆体（圆润饱满）** | **甜美、温柔、少女心、治愈** | **樱花粉+玫瑰粉+薰衣草紫** |
| 我的世界像素风 | Minecraft 像素方块美学，低分辨率块状质感 | 像素字体（等宽方块字） | 沙盒冒险、怀旧复古 | 草绿+钻石蓝+泥土棕 |
