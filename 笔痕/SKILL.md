...
**东方美学基调**（东方题材小说——古风/武侠/仙侠/历史——默认叠加）：在情绪基调之上，另立视觉基调层。五律——留白（负空间空灵，忌满塞）、意境（景外之景，含蓄叙事）、含蓄（含而不露，忌直白）、水墨（浓淡相生，可入题头与远山）、气韵（笔意流畅）。配色取中国传统色：黛墨、青灰、朱砂（点睛）、藤黄、石青石绿、金（镶饰）。构图可用散点透视、三段式（远山-中景-近景）、折枝对角式。写 prompt 时负向补"no excessive detail, no full-frame fill, no cluttered composition, no gaudy colors"。
...
**变更记录**：
- 2026-08-14: v1.3.0 基调层新增「东方美学基调」：东方题材小说（古风/武侠/仙侠/历史）默认叠加——五律（留白/意境/含蓄/水墨/气韵）、中国传统色、构图三法、负向约束。
