...
3. **轮末存检（收尾前硬闸，非可选）**——每条回复发出前自问四问：①本回合有可存之事否？②已判重、已存否？③未存之由说得出口否——说不出口此刻补存；④真无可存则答末明写「无甚要紧」，**不许静默略过**。多轮对话中连问连答尤须逐轮检，勿攒至会话末。
4. **存必告**——存了答末注「已存（类型）」；补录同。被点破「没存记忆」即失职，下轮起自查到底。
