...
| **东方水墨** 🏮 | 水墨晕染、留白意境、印章点睛 | MC 比例或剪影 | 黛墨/青灰/朱砂/宣纸白 | 古风、诗词、传统题材、OJ 文化题 |
...
```
配色：黛墨/青灰/朱砂/宣纸白——低饱和、重意境
人物：MC 比例或剪影式（头12×12 或远山剪影）
表情：含蓄克制（1-2px 点眼，无夸张嘴型）
Emoji：仅水墨可融元素（🌙🏮🍂🦢⛰️🌫️）+ 印章式朱砂方框
留白：≥40% 版面留白，虚处藏实
装饰：印章（朱砂色小方块+文字感）、水墨晕染背景、远山淡影
负向：禁高饱和、禁卡通贴纸感、禁满铺
适用于：古风、诗词、传统题材、OJ 文化题（如"将进酒""古风算法"）
```
...
- 2026-08-14: v1.2.0 新增「东方水墨」风格：水墨晕染、留白≥40%、黛墨/青灰/朱砂/宣纸白配色、印章点睛、剪影人物——适用古风/诗词/传统题材
