---
name: NeuralShelf
description: "NeuralShelf - 基于神经网络的智能文件整理系统，具备四阶段AI整理流程、神经感知分析、智能决策分类、安全执行和一键撤销恢复功能。使用场景：智能文件夹整理、重复文件处理、文档分类管理、存储空间优化。"
---

# NeuralShelf - 神经网络文件整理系统

基于神经网络的智能化文件整理解决方案，具备AI感知分析、智能决策、安全保护和详细报告功能。
